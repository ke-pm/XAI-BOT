...
def main():
    ...
    ## Other parameters
    parser.add_argument("--model", default="DialogPrompt", type=str, help="The model architecture to be fine-tuned.") 
    ...
    parser.add_argument("--fewshot", default=-1, type=int, help='number of training instances for few shot learning.')
    ...
    parser.add_argument("--learning_rate", default=5e-5, type=float, help="The learning rate for Adam.")
    ...
    parser.add_argument('--validating_steps', type=int, default=2000, help= "Validate every X updates steps.")
    parser.add_argument('--start_eval', type=int, default = 1, help= "Valid/Eval after X steps.")
