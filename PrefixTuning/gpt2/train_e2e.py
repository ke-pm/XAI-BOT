...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='dialog', help='')
    ...
    parser.add_argument('--lowdata_token', type=str, default='Dialog', help='')
    ...
    parser.add_argument('--init_shallow_word', type=str, default='dialog', help='')
    ...
    parser.add_argument('--max_steps', type=int, default=200000, help='')
    parser.add_argument('--eval_steps', type=int, default=2000, help='')
    ...
    # Added by MX
    parser.add_argument('--cache_dir', type=str, default='/home/elhadrik/contrast_LM/transformers/examples/control', help='cache dir')
    ...
    if args.mode == 'data2text':
        ...
        TRAIN_FILE = "/home/elhadrik/dart/data/v1.1.1/dart-v1.1.1-full-train.json"
        TEST_FILE = "/home/elhadrik/dart/data/v1.1.1/dart-v1.1.1-full-dev.json"
        folder_name = "triples_models/"


    elif args.mode == 'webnlg':
        # 2017 Challeng Version.
        TRAIN_FILE = "../data/webnlg_challenge_2017/train_reduced.json"
        TEST_FILE = "../data/webnlg_challenge_2017/dev.json"

        # v2
        # TRAIN_FILE = "/home/elhadrik/WebNLG/webnlg-dataset/release_v2/json/webnlg_release_v2_train.json"
        # TEST_FILE =  "/home/elhadrik/WebNLG/webnlg-dataset/release_v2/json/webnlg_release_v2_dev.json"
        ...
        TRAIN_FILE = "/home/elhadrik/datateller/datateller_train.txt"
        TEST_FILE = "/home/elhadrik/datateller/datateller_eval.txt"
        folder_name = "dialog_models/datateller/"
        if args.notes is not None and 'lowdata' in args.notes:
            app_special = ' --max_steps {} --eval_steps {} --save_steps -1 ' \
                          '--evaluate_during_training --per_device_eval_batch_size 32 ' \
                          '--warmup_steps {} --lowdata_token {} ' \
        ...
        TEST_FILE = '/home/elhadrik/contrast_LM/transformers/examples/seq2seq/cnn_dm/val.source'
        ...
        TRAIN_FILE = "/home/elhadrik/contrast_LM/transformers/examples/seq2seq/xsum/train.source"
        TEST_FILE = "/home/elhadrik/contrast_LM/transformers/examples/seq2seq/xsum/val.source"
    ...
    if load_prefix_model:
        LOAD_TRAIN_PREFIX = '/home/elhadrik/contrast_LM/transformers/examples/control/med_topic_gen'
