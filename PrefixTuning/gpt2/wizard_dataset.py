...
# datasets needed: MultiWOZ 2.2 [en]; Wizards of Wikipedia [en]; Schema-Guided Dialog [en]
# model: DialoGPT
"""
...
#have a recent version of pyarrow in the session before we continue
import pyarrow
...
multiwoz = load_dataset('multi_woz_v22', 'v2.2', ignore_verifications=True)
train_data = multiwoz['train']
valid_data = multiwoz['validation']
test_data = multiwoz['test']
#print(train_data[0])
